...
Defaults:
  TORCHTITAN_ROOT=/lus/flare/projects/datascience/seonghapark/torchtitan
...
TRAIN_PYTHON_BIN="${TRAIN_PYTHON_BIN:-/lus/flare/projects/datascience/seonghapark/llm_evaluation/venv/bin/python}"
TYRO_SITE_PACKAGES="${TYRO_SITE_PACKAGES:-${TORCHTITAN_ROOT}/.venv/lib/python3.12/site-packages}"
